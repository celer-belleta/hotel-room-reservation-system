...
public class DeluxeDetailsPanel extends JPanel {
    private final Color AURELIA_GOLD = new Color(197, 160, 89);
    private final Color NAVY_BLUE = new Color(44, 62, 80);

    public DeluxeDetailsPanel(GuestDashboard parent) {
        setLayout(new BorderLayout());
        setBackground(NAVY_BLUE);

        JLabel lblTitle = new JLabel("DELUXE ROOM", SwingConstants.CENTER);
        ...
        JLabel mainImage = new JLabel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon icon = new ImageIcon("src/images/deluxe.jpg");
        ...
        String highlights = "<html><b style='color:#C5A059; font-size:14pt;'>HIGHLIGHTS</b><br><br>" +
                "<font color='white'>• 1 King Bed<br>" +
                "• City View<br>" +
                "• Mini-Fridge<br>" +
        ...
        String details = "<html><b style='color:#C5A059; font-size:14pt;'>ROOM DETAIL</b><br><br>" +
                ...
                "<b>BED TYPE:</b> 1 King Bed</font></html>";
