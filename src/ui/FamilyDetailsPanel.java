...
public class FamilyDetailsPanel extends JPanel {
    ...
    public FamilyDetailsPanel(GuestDashboard parent) {
        setLayout(new BorderLayout());
        setBackground(NAVY_BLUE);

        JLabel lblTitle = new JLabel("FAMILY ROOM", SwingConstants.CENTER);
        lblTitle.setFont(new Font("Serif", Font.PLAIN, 36));
        lblTitle.setForeground(AURELIA_GOLD); // Gold Title
        ...
        JLabel mainImage = new JLabel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon icon = new ImageIcon("src/images/family.jpg");
        ...
        String highlights = "<html><b style='color:#C5A059; font-size:14pt;'>HIGHLIGHTS</b><br><br>" +
                "<font color='white'>• 2 Queen Beds<br>" +
                "• Pantry Area with Microwave<br>" +
                "• Mini-Bar<br>" +
        ...
        String details = "<html><b style='color:#C5A059; font-size:14pt;'>ROOM DETAIL</b><br><br>" +
                ...
                "<b>BED TYPE:</b> 2 Queen Beds</font></html>";
